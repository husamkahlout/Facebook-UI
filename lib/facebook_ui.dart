...
import 'package:facebook_ui/widget/storyWidget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView( 
        children: [
          Container(
              padding: EdgeInsets.only(right: 5, left: 5, bottom: 5, top: 7),
              child: Column(
                children: [
                  Container(
                              ...
                              Stack(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        image:
                                            DecorationImage(image: AssetImage("assets/icons/plus.png"))),
                                  ),
                                  Container(
